            ...
            <fieldset class="border p-2 my-4">
                ...
                <div class="row my-3">
                    ...
                    <div class="col-4 col-md-5">
                        <label class="form-label text-start w-100" for="selling-price">Retail Selling Price</label>
                        <input type="number" class="form-control" id="selling-price" name="retail_selling_price" placeholder="Enter retail selling price" required>
                    </div>
                </div>
            ...
            <fieldset class="border p-2 my-4">
                ...
                <div class="row my-3">
                    <div class="col-2">
                        ...
                        <input id="ti-year" class="form-control" type="number" name="tradein_year" placeholder="Enter trade-in's year" required>
                    </div>
                    <div class="col-3 col-md-3">
                        <label class="form-label text-start w-100" for="ti-make">Make</label>
                        <input id="ti-make" class="form-control" type="text" name="tradein_make" placeholder="Enter trade-in's make" required>
                    </div>
                    <div class="col-7 col-md-3">
                        <label class="form-label text-start w-100" for="ti-model">Model</label>
                        <input id="ti-model" class="form-control" type="text" name="tradein_model" placeholder="Enter trade-in's model" required>
                    </div>
                    <div class="col-md-4">
                        <label class="form-label text-start w-100" for="ti-color">Colour</label>
                        <input type="text" class="form-control" id='ti-color' name="tradein_colour" placeholder="Enter the trade-in's colour" required>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <input id="ti-model" class="form-control" type="text" name="tradein_serial" placeholder="Enter trade-in's model" required>
                    </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="checkbox-container text-start">
                            <div class="checkbox-group w-49 d-inline-block px-3">
                                <input type="radio" class="form-check-input" id="ti-mile-unit" name="tradein_unit" value="mi" required>
                                <label for="ti-mile-unit">MI</label>
                            </div>
                            <div class="checkbox-group w-49 d-inline-block">
                                <input type="radio" class="form-check-input" id="ti-km-unit" name="tradein_unit" value="km" required>
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="number" class="form-control" id='ti-odm-read' name="tradein_reading" placeholder="Enter trade-in's odometer reading" required>
                    </div>
                </div>
                ...
                <div class="row mt-4">
                    <div class="col-md-3">
                        ...
                        <input type="text" class="form-control" id='ti-lien' name="tradein_lien_payable" placeholder="Enter the name of lien creditor" required>
                    </div>
                    <div class="col-md-7">
                        <label class="form-label text-start w-100" for="ti_lien-creditor-address">Address</label>
                        <input type="text" class="form-control" id='ti_lien-creditor-address' name="tradein_address" placeholder="Enter the address of the lien creditor" required>
                    </div>
                    <div class="col-md-2">
                        <label class="form-label text-start w-100" for="ti_lien-amount">Lien amount</label>
                        <input type="number" class="form-control" id='ti_lien-amount' name="tradein_lien_amount" placeholder="Enter the amount due for the lien on the trade vehicle" required>
                    </div>
                </div>
